...
- [ft.cad3d](#ftcad3d) — Installs a 3D printing and CAD toolset for slicing and modeling: OrcaSlicer, Blender, FreeCAD, OpenSCAD, Inkscape, MeshLab, and f3d. OrcaSlicer's Creality K2 profiles cover Klipper-based slicing out of the box; the rest cover parametric/mesh modeling, vector art, and STL cleanup before slicing.
...
Installs a 3D printing and CAD toolset for slicing and modeling: OrcaSlicer, Blender, FreeCAD, OpenSCAD, Inkscape, MeshLab, and f3d. OrcaSlicer's Creality K2 profiles cover Klipper-based slicing out of the box; the rest cover parametric/mesh modeling, vector art, and STL cleanup before slicing.
