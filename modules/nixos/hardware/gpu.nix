...
# ------------------------------------------------------------------------------
# Consolidated configuration for NVIDIA (proprietary/open), AMD, and Intel
# integrated graphics, with PRIME offloading for hybrid/Optimus systems.
# Autodetects vendor and bus IDs from ft.hardware.facter.reportPath when
...
let
  ...
  # PRIME; an absent, empty, or malformed value would cause sysfsIdToPrime to crash.
  validSysfsId =
