...
in
{
  meta.description = "Connects the machine to a Tailscale mesh network, trusts the tailscale0 interface in the firewall, and installs the Trayscale GUI tray app. Set ft.tailscale.useRoutingFeatures = \"server\" to run as an exit node.";
